...
<html>
	<head>
		<title>Belajar Laravel 5.3 - CRUD - @yield('title')</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="navbar navbar-info">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="javascript:void(0)">BELAJAR LARAVEL</a>
				</div>
		...
		<script scr="{{ asset('bootstrap-material-design-master/dist/js/ripples.min.js') }}"></script>
