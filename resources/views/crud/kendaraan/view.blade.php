            ...
            <tbody>
                ...
                @foreach ($kendaraans as $kendaraan)
                    <tr>
                        ...
                        <td>{{ $kendaraan->kota($kendaraan->user->id)->nama_kota }}</td>
                        <td>
                            <center>
                                <a href="{{ URL('kendaraan/show') }}/{{ $kendaraan->id }}" class="btn btn-sm btn-raised btn-info">Edit</a>
                                <a href="{{ URL('kendaraan/destroy') }}/{{ $kendaraan->id }}" class="btn btn-sm btn-raised btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                            </center>
                        </td>
                    </tr>
                @endforeach
